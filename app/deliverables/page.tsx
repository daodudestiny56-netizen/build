  ...
  return (
    <div className="min-h-screen bg-[#0F1115] text-[#EDEAE2] flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-4 sm:p-6 space-y-6">
        {/* Header Stub */}
        <div className="card-dispatch p-5 bg-[#17191F] flex items-center space-x-3">
          <div className="p-2 bg-[#FF4405] text-white border border-[#EDEAE2]">
            <FileCheck className="w-6 h-6 stroke-[2.5]" />
          </div>
          <div>
            <h1 className="font-display text-xl font-bold tracking-tight text-[#EDEAE2] uppercase">
        ...
        <div className="card-dispatch bg-[#17191F] p-4 sm:p-6 space-y-5 font-mono text-xs leading-relaxed">
