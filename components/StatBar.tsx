  ...
  const cards = [
    {
      ...
      label: 'TOTAL TICKETS',
      value: stats.total,
      borderClass: 'border-2 border-[#262933]',
      bgClass: 'bg-[#16181E]',
      textClass: 'text-[#F4F0EA]',
    },
    {
      id: 'open',
      label: 'IN PROGRESS',
      value: stats.open,
      borderClass: 'border-2 border-[#F4F0EA]',
      bgClass: 'bg-[#16181E]',
      textClass: 'text-[#F4F0EA]',
    },
    {
      ...
      label: 'HIGH URGENCY',
      value: stats.urgent,
      borderClass: isUrgentAlert ? 'border-3 border-[#FF3B00] shadow-[4px_4px_0px_#FF3B00]' : 'border-2 border-[#262933]',
      bgClass: 'bg-[#16181E]',
      textClass: isUrgentAlert ? 'text-[#FF3B00]' : 'text-slate-300',
    },
    {
      id: 'escalated',
      label: 'OVERDUE (ESCALATED)',
      value: stats.escalated,
      borderClass: isEscalatedAlert ? 'border-3 border-[#FF3B00] bg-[#16181E] shadow-[4px_4px_0px_#FF3B00]' : 'border-2 border-[#262933]',
      bgClass: 'bg-[#16181E]',
      textClass: isEscalatedAlert ? 'text-[#FF3B00] font-extrabold' : 'text-slate-300',
    },
    {
      id: 'resolved',
      label: 'RESOLVED TODAY',
      value: stats.resolved_today,
      borderClass: 'border-2 border-[#00E676]',
      bgClass: 'bg-[#16181E]',
